...
function setBottom(name,content,html=false){
 ...
 if(name==="terminal"){
   refs.bottom.innerHTML='<div class="terminalSessionBar"><span class="activeSession">Local</span><span class="terminalGrow"></span><span class="terminalAction">＋</span><span class="terminalAction">⌄</span><span class="terminalAction">⋮</span></div><div class="terminalViewport"><pre class="terminalText">'+renderTerminalText(content||"$ ")+'</pre></div>';
