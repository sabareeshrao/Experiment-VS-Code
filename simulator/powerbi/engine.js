...
async function applyStep(step,animate,token){
 ...
 else if(a==="setVisualType"){const v=getVisual(d.id||state.selectedVisualId);if(v){v.type=d.type;state.paneTab="visualizations";state.statusText="Visual type: "+prettyType(d.type);}}
